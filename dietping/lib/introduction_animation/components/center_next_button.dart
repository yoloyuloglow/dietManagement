...
class CenterNextButton extends StatelessWidget {
  ...
  const CenterNextButton(
      {Key? key, required this.animationController, required this.onNextClick, required this.onLoginClick,})
      : super(key: key);
            ...
            child: SlideTransition(
              ...
              child: Row(
                ...
                children: [
                  ...
                  InkWell( // InkWell로 텍스트를 감싸서 클릭 가능하도록 만듦
                    onTap: onLoginClick, // 로그인 클릭 시 실행되는 콜백
                    child: Text(
                      'Login',
                      style: TextStyle(
                        color: Color(0xff132137),
